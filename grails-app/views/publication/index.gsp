		...
		<div id="list-publication" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="price" title="${message(code: 'publication.price.label', default: 'Price')}" />
				...
				<g:each in="${publicationInstanceList}" status="i" var="publicationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: publicationInstance, field: "description")}</td>
					
						<td>${fieldValue(bean: publicationInstance, field: "price")}</td>
